...
def login_required(f):
    ...
    def decorated_function(*args, **kwargs):
        if "logged_in" in session :
            ...
            flash("Bu Sayfayı Görüntülemek için Lütfen GİRİŞ YAPINIZ.....!!!!","danger")
...
def logout():
    session.clear()
    #session bu clear ile öldürüldü
...
def delete(id):
    ...
    if result > 0 :
        ...
        flash("Böyle bir Makale Yok veya Bu İşlem için Gerekli Yetkiye Sahip Değilsiniz...!!!","danger")
        return redirect(url_for("index"))
#Makale Güncelle
...
def update(id):
    if request.method == "GET":
        ...
        flash("Makale Başarıyla Güncellendi...","primary")
